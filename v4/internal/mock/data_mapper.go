...
func (m *DataMapper) Delete(arg0 context.Context, arg1 work.MapperContext, arg2 ...work.Entity) error {
	m.ctrl.T.Helper()
...
func (m *DataMapper) Insert(arg0 context.Context, arg1 work.MapperContext, arg2 ...work.Entity) error {
	m.ctrl.T.Helper()
	varargs := []interface{}{arg0, arg1}
	for _, a := range arg2 {
		varargs = append(varargs, a)
...
func (m *DataMapper) Update(arg0 context.Context, arg1 work.MapperContext, arg2 ...work.Entity) error {
	m.ctrl.T.Helper()
	varargs := []interface{}{arg0, arg1}
	for _, a := range arg2 {
		varargs = append(varargs, a)
